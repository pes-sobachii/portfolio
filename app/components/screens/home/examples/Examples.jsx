...
import newTodoImg from '../../../../assets/photo_2023-03-16_11-50-51.jpg'
            ...
            <div>
                <div className={styles.row}>
                    <div className={styles.image}>
                        <Image src={newTodoImg} alt='Todo app'/>
                    </div>
                    <div className={styles.info}>
                        <h3 className={styles.name}>Todo App</h3>
                        <p className={styles.stack}>Stack: Next.js, React-Query, Styled-Components, Node.js, Express, MySQL</p>
                        <p className={styles.buttons}>
                            <a target='_blank' href="https://github.com/pes-sobachii/todo_frontend">
                                <button
                                    className={styles.repo}>Frontend Repo
                                </button>
                            </a>
                            <a target='_blank' href="https://github.com/pes-sobachii/todo_backend">
                                <button
                                    className={styles.repo}>Backend Repo
                                </button>
                            </a>
                            <a target='_blank' href="https://todo-frontend-sable.vercel.app/register">
                                <button
